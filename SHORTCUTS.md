...
**Default mode:** plain text (no slash) in the Vomit AI terminal runs the agent with the open document and current folder as context. Multi-step _code_ work is a better fit for the **Pi tab** (pi.dev coding-agent harness).
